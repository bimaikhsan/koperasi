<template>
    ...
    <aside v-if="isLoggedIn" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href="#">

        <img :src="require('/img/koperasi-icon.png').default" class="navbar-brand-img h-100" alt="main_logo">

        <!-- <img src="img/koperasi-icon.png" class="navbar-brand-img h-100" alt="main_logo"> -->
        <span class="ms-1 font-weight-bold text-white">Koperasi</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
            <router-link to="/dashboard" v-slot="{ href, navigate, isActive, isExactActive}" class="nav-link text-white">
  ...
  <main v-if="isLoggedIn" class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Navbar -->
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <!-- <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3"  @click="logout">Logout</a>
            </li>
            <li class="nav-item d-flex align-items-center">
  ...
  <div class="fixed-plugin" v-if="isLoggedIn">
